...
Terminal 1: Run terraform apply

Terminal 2: While the first is running, try terraform plan or terraform apply

Expected Result: The second command should fail with an error like:
...
Lock Info:
  ...
  Who:       <user>@<hostname>
Check S3 Bucket: During the operation, you'll see a .tflock file temporarily in your S3 bucket

After Completion: The lock file will be automatically deleted (delete marker with versioning)
